...
export const TRANSLATIONS = {
  en: {
    ...
    revealCredited: "₹500.00 ready for instant transfer...",
    revealFreeze: "HOLD ON...",
    revealReflect: "Hi, {name}",
    revealTrustMsg: "You just entered your private name, phone number, and email address on an unverified webpage for ₹500.",
    revealBigText: "THIS WASN'T A SCAM.",
    revealLessonText: "IT WAS A LESSON.",
    revealSafeMsg: "Rest assured: Nothing you typed was logged, sent, or saved. All data stayed 100% inside your browser session.",
  ...
  kn: {
    ...
    revealCredited: "₹500.00 ಜಮಾ ಮಾಡಲು ಸಿದ್ಧವಾಗಿದೆ...",
    revealFreeze: "ಒಂದು ನಿಮಿಷ ತಡೆಯಿರಿ...",
    revealReflect: "ನಮಸ್ಕಾರ, {name}",
    revealTrustMsg: "ನೀವು ಯಾವುದೇ ಪರಿಶೀಲನೆ ಇಲ್ಲದ ವೆಬ್‌ಸೈಟ್‌ನಲ್ಲಿ ₹500 ಗಾಗಿ ನಿಮ್ಮ ಹೆಸರು, ಫೋನ್ ಸಂಖ್ಯೆ ಮತ್ತು Email ಅನ್ನು ನೀಡಿದ್ದೀರಿ.",
    revealBigText: "ಇದು SCAM ಅಲ್ಲ.",
    revealLessonText: "ಇದು ಒಂದು ಸೈಬರ್ ಪಾಠ (LESSON).",
    revealSafeMsg: "ಖಾತರಿ ಇರಲಿ: ನೀವು ನೀಡಿದ ಯಾವುದೇ ವಿವರಗಳನ್ನು ನಾವು Collect, Save ಅಥವಾ Transmit ಮಾಡಿಲ್ಲ. ಎಲ್ಲವೂ ನಿಮ್ಮ Browser ನಲ್ಲೇ ಸುರಕ್ಷಿತವಾಗಿದೆ.",
